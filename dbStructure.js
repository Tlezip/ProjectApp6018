...
db.connect(function(err){
    ...
    const sql = [
        ...
        'CREATE TABLE Request (RequestID INT AUTO_INCREMENT PRIMARY KEY,Username VARCHAR(16) NOT NULL,TypeReserve VARCHAR(10),Day VARCHAR(10),timeStart TIMESTAMP DEFAULT 0,timeEnd TIMESTAMP DEFAULT 0,Subject VARCHAR(30),Described TEXT,Status VARCHAR(15), isUpdate INT,FOREIGN KEY (Username) REFERENCES UserDetail(Username))',
